...
public class TaskServiceImpl implements TaskService {
  ...
  public Task updateTask(Long id, Task task) {
    ...
    if (task.getRecurrence() == null) {
      ...
      taskToUpdate.setRecurrenceEvery(0);
      taskToUpdate.setRecurrenceUnit(null);
    ...
    if (task.getNote() != null && !task.getNote().equals(taskToUpdate.getNote())) {
      taskToUpdate.getNote().setContent(task.getNote().getContent());
    }
